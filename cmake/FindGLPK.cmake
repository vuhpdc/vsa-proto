# Code borrowed from: https://github.com/gnudatalanguage/gdl/blob/master/CMakeModules/FindGLPK.cmake
...
find_path(
  GLPK_INCLUDE_DIR
  glpk.h
  PATHS /usr/local/include /usr/include ${GLPK_DIR}/include
)
...
if( GLPK_INCLUDE_DIR )
  find_library(
    ...
    PATHS /usr/lib64 /usr/local/lib /usr/lib ${GLPK_DIR}/lib
  )
  if( GLPK_LIBRARY )
